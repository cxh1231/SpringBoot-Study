...
public class KaptchaConfig {
    ...
    public DefaultKaptcha getKaptchaBeanMathOne() {
        ...
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "com.cxhit.captcha.config.KaptchaMathOneTextCreator");
        // 验证码文本字符间距 默认为2
    ...
    public DefaultKaptcha getKaptchaBeanMathTwo() {
        ...
        properties.setProperty(KAPTCHA_SESSION_CONFIG_KEY, "kaptchaCodeMath");
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "com.cxhit.captcha.config.KaptchaMathTwoTextCreator");
        // 验证码文本字符间距 默认为2
        properties.setProperty(KAPTCHA_TEXTPRODUCER_CHAR_SPACE, "3");
        // 验证码文本字符长度 默认为5
        properties.setProperty(KAPTCHA_TEXTPRODUCER_CHAR_LENGTH, "6");
